...
// ==============================================================
`timescale 1ns/1ps
module loop_uhat_sparse_CTRL_BUS_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER             = 6'h08,
    ADDR_ISR             = 6'h0c,
    ADDR_ELEMENTS_DATA_0 = 6'h10,
    ADDR_ELEMENTS_CTRL   = 6'h14,
    ADDR_TOL_DATA_0      = 6'h18,
    ADDR_TOL_DATA_1      = 6'h1c,
    ADDR_TOL_CTRL        = 6'h20,
    ADDR_L_EXP_DATA_0    = 6'h24,
    ADDR_L_EXP_DATA_1    = 6'h28,
    ADDR_L_EXP_CTRL      = 6'h2c,
    ADDR_R_EXP_DATA_0    = 6'h30,
    ADDR_R_EXP_DATA_1    = 6'h34,
    ADDR_R_EXP_CTRL      = 6'h38,
    WRIDLE               = 2'd0,
    WRDATA               = 2'd1,
    WRRESP               = 2'd2,
    WRRESET              = 2'd3,

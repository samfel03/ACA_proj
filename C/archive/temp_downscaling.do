...
import delimited "Data/global_temp.csv", clear
...
* Save data
compress
save "Data/derived/global_temp.dta", replace

* Read climatology
import delimited "Data/climatology.csv", clear 

compress
save "Data/derived/climatology.dta", replace
...
qui merge m:1 lat lon using "Data/derived/climatology.dta", nogen
...
qui merge m:1 lat lon using "Data/derived/geo_data.dta", nogen

* Merge geographic data global temperature
qui merge m:1 year using "Data/derived/global_temp.dta", keep(3) nogen
...
compress
save "Data/derived/downscaling_reg.dta", replace


********************************************************************************
* Perform temperature downscaling

use "Data/derived/downscaling_reg.dta", clear
...
export delimited using "Data/derived/scaler_temp.csv", replace

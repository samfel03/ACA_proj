...
# 2 "<built-in>" 2
# 1 "../CCE-C/library/src/xnrm2.c" 2
# 13 "../CCE-C/library/src/xnrm2.c"
# 1 "C:\\Research\\CU-Spur-Sean\\spurFPGA\\CCE-C\\library\\include\\xnrm2.h" 1
# 16 "C:\\Research\\CU-Spur-Sean\\spurFPGA\\CCE-C\\library\\include\\xnrm2.h"
...
# 17 "C:\\Research\\CU-Spur-Sean\\spurFPGA\\CCE-C\\library\\include\\xnrm2.h" 2
# 1 "C:\\Xilinx\\Vitis_HLS\\2023.2\\win64\\tools\\clang-3.9-csynth\\lib\\clang\\7.0.0\\include\\stddef.h" 1 3
...
# 19 "C:\\Research\\CU-Spur-Sean\\spurFPGA\\CCE-C\\library\\include\\xnrm2.h" 2
...
# 14 "../CCE-C/library/src/xnrm2.c" 2
...
# 15 "../CCE-C/library/src/xnrm2.c" 2
...
#pragma pack(pop)
# 16 "../CCE-C/library/src/xnrm2.c" 2
...
double b_xnrm2(int n, const double x[8], int ix0)
{
  ...
  kend = (ix0 + n) - 1;
  VITIS_LOOP_27_1: for (k = ix0; k <= kend; k++) {
    double absxk;
    absxk = fabs(x[k - 1]);
    if (absxk > scale) {
      double t;
...
double xnrm2(int n, const double x[64], int ix0)
{
  ...
  scale = 3.3121686421112381E-170;
  kend = (ix0 + n) - 1;
  VITIS_LOOP_53_1: for (k = ix0; k <= kend; k++) {
    double absxk;
    absxk = fabs(x[k - 1]);
    if (absxk > scale) {
      double t;

...
HD_PWD='C:/Research/CU-Spur-Sean/spurFPGA/SoCNANDTest/Vivado/Vivado.runs/design_3_add_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_3_add_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_3_add_0_1.tcl

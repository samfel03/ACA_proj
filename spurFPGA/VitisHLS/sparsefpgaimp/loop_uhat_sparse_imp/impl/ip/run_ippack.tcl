...
set Library     "hls"
set IPName      "loop_uhat_sparse"
set Version     "2.0"
set DisplayName "Loop_uhat_sparse"
set Revision    "2113672566"
set Description "First iteration of AXI Stream Implementation"
set Device      "zynq"
set AutoFamily  ""
set Taxonomy    "/VITIS_HLS_IP"
set target_part "xc7z007s-clg400-1"
set target_lang "verilog"
set has_xpm_memory "0"
set has_blackbox "false"
set sdx_kernel_type "hls"
set xo_kernel_name "loop_uhat_sparse"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/Research/CU-Spur-Sean/spurFPGA/VitisHLS/sparsefpgaimp/loop_uhat_sparse_imp"
set solution_json_file [file join $solution_dir [file tail $solution_dir]_data.json]
set debug_dir "C:/Research/CU-Spur-Sean/spurFPGA/VitisHLS/sparsefpgaimp/loop_uhat_sparse_imp/.debug"
set xo_hls_files_dir ""
set hdl_module_list {loop_uhat_sparse_sitodp_64ns_64_6_no_dsp_1
...
set kernel_xo ""
set detect_deadlock_json "loop_uhat_sparse_message_dict.json"

## Variables
set Top "loop_uhat_sparse"
set TopNoPrefix "loop_uhat_sparse"

...
using hls::sim::Byte;
extern "C" void loop_uhat_sparse(volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, int, double, double, double);
extern "C" void apatb_loop_uhat_sparse_hw(volatile void * __xlx_apatb_param_inStream_V_data_V, volatile void * __xlx_apatb_param_inStream_V_keep_V, volatile void * __xlx_apatb_param_inStream_V_strb_V, volatile void * __xlx_apatb_param_inStream_V_last_V, volatile void * __xlx_apatb_param_outStream_V_data_V, volatile void * __xlx_apatb_param_outStream_V_keep_V, volatile void * __xlx_apatb_param_outStream_V_strb_V, volatile void * __xlx_apatb_param_outStream_V_last_V, int __xlx_apatb_param_ELEMENTS, double __xlx_apatb_param_tol, double __xlx_apatb_param_L_exp, double __xlx_apatb_param_R_exp) {
using hls::sim::createStream;
auto* sinStream_V_data_V = createStream((hls::stream<long long>*)__xlx_apatb_param_inStream_V_data_V);
...
auto* soutStream_V_last_V = createStream((hls::stream<char>*)__xlx_apatb_param_outStream_V_last_V);
  // DUT call
  loop_uhat_sparse(sinStream_V_data_V->data<long long>(), sinStream_V_keep_V->data<char>(), sinStream_V_strb_V->data<char>(), sinStream_V_last_V->data<char>(), soutStream_V_data_V->data<long long>(), soutStream_V_keep_V->data<char>(), soutStream_V_strb_V->data<char>(), soutStream_V_last_V->data<char>(), __xlx_apatb_param_ELEMENTS, __xlx_apatb_param_tol, __xlx_apatb_param_L_exp, __xlx_apatb_param_R_exp);
sinStream_V_data_V->transfer((hls::stream<long long>*)__xlx_apatb_param_inStream_V_data_V);

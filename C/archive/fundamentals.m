...
load('Data/trmult_reduced.mat')
load('Data/H0_areal.mat') //load('Data/H0_norm.mat')
load('Data/pop_Gecon.mat')
load('Data/wage_Gecon.mat')
...
load('Data/CO2_EDGAR.mat') // cell level CO2 emissions
fossil_country = csvread('Data/CO2_country.csv'); // country level CO2 emissions in GtCO2
clean_country = csvread('Data/clean_country.csv'); // country level clean energy use in GtCO2
...
save('Data/derived/amen_util.mat','amen_util_H0','-v7.3');
save('Data/derived/prod.mat','prod_H0','-v7.3');
save('Data/derived/realgdp.mat','realgdp_H0','-v7.3');

////
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Compute migration costs that rationalize population in 2001

load('Data/derived/amen_util.mat')
load('Data/derived/prod.mat')
data_table = readtable('Data/HDI_GDPpc.csv');
...
m2 = m2_i / min(m2_i);
save('Data/derived/m2.mat','m2','-v7.3');
...
load('Data/derived/amen_util.mat')
load('Data/derived/prod.mat')
load('Data/derived/realgdp.mat')
load('Data/derived/m2.mat')
...
save('Data/derived/prod_model_1990.mat','phi_summ_1990','-v7.3');
...
writetable(table_amen_prod,'Data/derived/amen_prod.csv') 

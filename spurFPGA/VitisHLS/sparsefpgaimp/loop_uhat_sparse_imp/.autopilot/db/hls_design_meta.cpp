...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("outStream_TDATA", 64, hls_out, 4, "axis", "out_data", 1),
	Port_Property("outStream_TVALID", 1, hls_out, 7, "axis", "out_vld", 1),
	Port_Property("outStream_TREADY", 1, hls_in, 7, "axis", "out_acc", 1),
	Port_Property("outStream_TKEEP", 8, hls_out, 5, "axis", "out_data", 1),
	Port_Property("outStream_TSTRB", 8, hls_out, 6, "axis", "out_data", 1),
...
const char* HLS_Design_Meta::dut_name = "loop_uhat_sparse";

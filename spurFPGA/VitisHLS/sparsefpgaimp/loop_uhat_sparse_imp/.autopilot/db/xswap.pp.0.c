...
# 2 "<built-in>" 2
# 1 "../CCE-C/library/src/xswap.c" 2
# 13 "../CCE-C/library/src/xswap.c"
# 1 "C:\\Research\\CU-Spur-Sean\\spurFPGA\\CCE-C\\library\\include\\xswap.h" 1
# 16 "C:\\Research\\CU-Spur-Sean\\spurFPGA\\CCE-C\\library\\include\\xswap.h"
...
# 17 "C:\\Research\\CU-Spur-Sean\\spurFPGA\\CCE-C\\library\\include\\xswap.h" 2
# 1 "C:\\Xilinx\\Vitis_HLS\\2023.2\\win64\\tools\\clang-3.9-csynth\\lib\\clang\\7.0.0\\include\\stddef.h" 1 3
...
# 19 "C:\\Research\\CU-Spur-Sean\\spurFPGA\\CCE-C\\library\\include\\xswap.h" 2
...
# 14 "../CCE-C/library/src/xswap.c" 2
...
# 15 "../CCE-C/library/src/xswap.c" 2


void xswap(double x[64], int ix0, int iy0)
{
  int k;
  VITIS_LOOP_20_1: for (k = 0; k < 8; k++) {
    double temp;
    int i;
    int temp_tmp;
    temp_tmp = (ix0 + k) - 1;

...
entity loop_uhat_sparse_loop_uhat_sparse_Pipeline_VITIS_LOOP_30_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of loop_uhat_sparse_loop_uhat_sparse_Pipeline_VITIS_LOOP_30_1 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln30_reg_165 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal add_ln30_fu_107_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal sext_ln30_cast_fu_85_p1 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                elsif (((icmp_ln30_reg_165 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
    ...
    add_ln30_fu_107_p2 <= std_logic_vector(unsigned(e_1_reg_160) + unsigned(ap_const_lv64_1));
    ...
    ap_condition_exit_pp0_iter0_stage6_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage6, ap_block_pp0_stage6_subdone, icmp_ln30_reg_165)
    begin
        if (((icmp_ln30_reg_165 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage6_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage6))) then 
    ...
    ap_condition_exit_pp0_iter1_stage1_assign_proc : process(ap_enable_reg_pp0_iter1, icmp_ln30_reg_165, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1_subdone)
    begin
        if (((icmp_ln30_reg_165 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
    ...
    ap_sig_allocacmp_rhs_load_assign_proc : process(ap_enable_reg_pp0_iter2, ap_CS_fsm_pp0_stage1, rhs_fu_34, ap_block_pp0_stage1, grp_fu_308_p_dout0)
    begin
    ...
    grp_fu_308_p_din0 <= ap_sig_allocacmp_rhs_load;
    grp_fu_308_p_din1 <= mul1_reg_169;
    grp_fu_308_p_opcode <= ap_const_lv2_0(1 - 1 downto 0);
    grp_fu_315_p_ce <= ap_const_logic_1;
    grp_fu_315_p_din0 <= bitcast_ln31;
    grp_fu_315_p_din1 <= integral_load;
    icmp_ln30_fu_102_p2 <= "1" when (signed(e_fu_38) < signed(wide_trip_count_cast_reg_155)) else "0";
    rhs_out <= rhs_fu_34;

    rhs_out_ap_vld_assign_proc : process(icmp_ln30_reg_165, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1_11001)
    begin
        if (((icmp_ln30_reg_165 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
        ...
        sext_ln30_cast_fu_85_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(sext_ln30),64));

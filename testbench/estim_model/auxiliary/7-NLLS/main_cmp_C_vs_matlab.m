...
readveclist = {'H','prod0','pop5_dens','u0','a_norm','C_vect','emi0_ff',...
    ...
    'natal_data', 'pop_data','natal0', 'natal20', 'clean_energy_data', 'emi_ff_data', 'emi_ff_data_tend','m2_i'}; % 'price_clean0_world' excluded
...
diff(6)=diff(6)-1; % C_vect indexes are scaled by one in C

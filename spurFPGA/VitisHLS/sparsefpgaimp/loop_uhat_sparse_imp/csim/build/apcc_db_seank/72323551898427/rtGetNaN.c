...
printf("\n\{ BEGIN @rtGetNaN\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = load double* @rtNaN, align 8, !dbg !3 for 0x%I64xth hint within @rtGetNaN  --> \n", ++aesl_llvm_cbe_1_count);
  llvm_cbe_tmp__1 = (double )*(&rtNaN);
if (AESL_DEBUG_TRACE)
...
printf("\n\{ BEGIN @rtGetNaNF\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = load float* @rtNaNF, align 4, !dbg !3 for 0x%I64xth hint within @rtGetNaNF  --> \n", ++aesl_llvm_cbe_3_count);
  llvm_cbe_tmp__2 = (float )*(&rtNaNF);
if (AESL_DEBUG_TRACE)

...
typedef struct env_t
{
	...
	//real emi0_cell;	  // CO2 emissions at cell level for 2000 - NPOSLANDx1
	...
	//real conv_usd;		 // Dollar conversion, scalar
	// costCO2_fct NOT USED
	// Initialized in: init_energy_productivity
	//real fossil0_cell; 	// Construct energy use at the cell level, equation (7), (17048x1)
	//real price_clean0; 		// Construct energy price at the cell level by source, equations (52), (53), (17048x1)
	//real price_fossil0; 	//, (17048x1)
	...
	//real *country_data; 	// net birth historical data, data for years < 2001, 8568x1 
	//real *year_data;		// data for years < 2001, 8568x1 

...
architecture behave of loop_uhat_sparse_control_s_axi is
    ...
    constant ADDR_UHAT_I_DATA_0 : INTEGER := 16#1c#;
    constant ADDR_UHAT_I_DATA_1 : INTEGER := 16#20#;
    constant ADDR_UHAT_I_CTRL   : INTEGER := 16#24#;
    constant ADDR_R_DATA_0      : INTEGER := 16#28#;
    constant ADDR_R_DATA_1      : INTEGER := 16#2c#;
    constant ADDR_R_CTRL        : INTEGER := 16#30#;

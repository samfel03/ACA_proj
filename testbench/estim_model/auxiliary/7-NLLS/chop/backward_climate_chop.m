...
realgdp0_w = sum(realgdp0.*l0_model.*H)/lbar;   % ******** DEVELOP: l0_model and realgdp0 used only here
...
debug_backward_climate_init;    % DEBUG
...
for t = 1:T
    ...
    % Precompute auxiliary variables to equation (88)               -->  DIFFERENT EXPONENTS
    BL_aux = amen(:,t).^() .* ...

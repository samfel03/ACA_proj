...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "loop_uhat_sparse.autotvin.dat"
	set constFileTvOut       "loop_uhat_sparse.autotvout.dat"
	set constFileHdlTvIn     "loop_uhat_sparse.autohdltvin.dat"
	set constFileHdlTvOut    "loop_uhat_sparse.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

...
extern "C"
hls::sim::Byte<4> add_hw_stub_wrapper(hls::sim::Byte<4>, hls::sim::Byte<4>);

extern "C"
hls::sim::Byte<4> apatb_add_hw(hls::sim::Byte<4> __xlx_apatb_param_a, hls::sim::Byte<4> __xlx_apatb_param_b)
{
  ...
  try {
    ...
    ap_return = add_hw_stub_wrapper(__xlx_apatb_param_a, __xlx_apatb_param_b);

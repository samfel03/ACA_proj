...
#define INPUTPATH "/Users/alessandroperi/Dropbox/Projects/CCE-FPGA/CCE-C/testbench/initialize/auxiliary/5-vectorize/"
...
#define IPOSLANDTPLUS1(i, t) (t * NPOSLAND + i) // time t-location i: col_idx*NROWS+ row_idx 
#define IPOSLANDT(i, t) (t * NPOSLAND + i)		// time t-location i: col_idx*NROWS+ row_idx 
#define IPROVA(i, j) (j * 4 + i)				// col_idx*NROWS+ row_idx 

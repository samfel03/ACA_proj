...
HD_PWD='C:/Research/CU-Spur-Sean/spurFPGA/VivadoProjectZync/VivadoProjectZync.runs/design_3_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_3_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_3_auto_pc_0.tcl

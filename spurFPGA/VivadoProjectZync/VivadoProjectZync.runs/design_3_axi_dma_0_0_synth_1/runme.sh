...
HD_PWD='C:/Research/CU-Spur-Sean/spurFPGA/VivadoProjectZync/VivadoProjectZync.runs/design_3_axi_dma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_3_axi_dma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_3_axi_dma_0_0.tcl

...
HD_PWD='C:/Research/CU-Spur-Sean/spurFPGA/VivadoProjectZync/VivadoProjectZync.runs/design_3_loop_uhat_sparse_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_3_loop_uhat_sparse_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_3_loop_uhat_sparse_0_1.tcl

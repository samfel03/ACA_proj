...
set name doGain_mul_32s_32s_32_2_1
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 3 \
			corename doGain_CTRL_BUS_axilite \
			name doGain_CTRL_BUS_s_axi \
			ports {$port_CTRL_BUS} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler doGain_CTRL_BUS_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
# RegSlice definition:
set ID 18
set RegSliceName doGain_regslice_both
set RegSliceInstName doGain_regslice_both_U
set CoreName ap_simcore_doGain_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {

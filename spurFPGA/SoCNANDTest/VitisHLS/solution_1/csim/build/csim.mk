...
HLS_SOURCES = ../../../nandtb.cpp ../../../add.cpp
...
$(ObjDir)/nandtb.o: ../../../nandtb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../nandtb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -IC:/Research/CU-Spur-Sean/spurFPGA/SoCNANDTest/VitisHLS/. -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/nandtb.d

...
int main(int argc, char **argv) {
  ...
  // DONE: UPMEM: SERIAL CPU-DPU TRANSFER HERE
  ...
  DPU_FOREACH(dpu_set, dpu, i) {
    ...
    // TODO: offset is sus
    DPU_ASSERT(dpu_copy_from(dpu, DPU_MRAM_HEAP_POINTER_NAME, 0, vector_multiplication + mem_address, input_arguments[i].accumulator_arr_size * sizeof(DPU_TReal)));
